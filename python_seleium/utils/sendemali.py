...
class Email:
    def __init__(self, server='smtp.qq.com', sender='513024429@qq.com', password='txvxbqbwkxgzbiba', receiver='513024429@qq.com', title='百度搜索测试报告', message=None, path=None):
        """初始化Email
    ...
    def send(self):
        ...
        if self.message:
            ...
            msgAlternative.attach(MIMEText(self.message, 'html', 'utf-8'))
